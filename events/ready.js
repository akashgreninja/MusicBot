...
setInterval(() => client.user.setActivity({ name: `${config.status} - BLAH BLAH ${Number(client?.shard?.ids)+1 ? Number(client?.shard?.ids)+1 : "1"}`, type: ActivityType.Listening }), 10000);
